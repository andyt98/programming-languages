...
(println "Test 1")
(println test1)
(eval-exp test1)       ; (const -28)
(eval-exp-wrong test1) ; (const -28)


; legal AST, but this should throw an error when is eval
...
(println "Test 2")
(println test2)
;(eval-exp test2)          ; this throws a propper error message
;(eval-exp-wrong test2)   ; this throws a bad erorr message



; non-legal AST, fine not to throw a propper message
