...
(define tests
  (test-suite
   ...
   (check-equal? (string-append-map 
                 ...
                 (list "dan.jpg" "dog.jpg" "curry.jpg" "dog2.jpg") "string-append-map test")
   ...
   (check-equal? (list-nth-mod (list 0 1 2 3 4) 4) 4 "list-nth-mod test 3")
   (check-equal? (list-nth-mod (list 0 1 2 3 4) 5) 0 "list-nth-mod test 4")
   (check-equal? (list-nth-mod (list 0 1 2 3 4) 13) 3 "list-nth-mod test 5")
   (check-exn exn? (lambda () (list-nth-mod (list 0 1 2 3 4) -2)) "list-nth-mod: negative number")
   (check-exn exn? (lambda () (list-nth-mod null 3)) "list-nth-mod: empty list")
   
   (check-equal? (stream-for-n-steps ones 2) (list 1 1) "stream-for-n-steps test 1")
   (check-equal? (stream-for-n-steps nats 3) (list 1 2 3) "stream-for-n-steps test 2")
